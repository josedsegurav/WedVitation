...
export const WEDDING = {
  ...
  dateMedallion: `${DATE.getDate() + 1} ${DATE.toLocaleDateString('en-US', { month: 'long' })} · ${DATE.getFullYear()}`,
  location: 'Iglesia Católica Sagrada Familia - El Condado',
  reception: 'Quinta Jose Luis',
...
export const EVENTS = [
  ...
  },
  {
    ...
    mapsUrl: `https://maps.google.com/?q=${WEDDING.reception}`,
  },
]
...
export const GALLERY = [
  { id: 0, gradient: 'var(--gradient-gallery-0)', label: 'Engagement', src: '/images/1.png' },
  { id: 1, gradient: 'var(--gradient-gallery-1)', label: 'Together', src: '/images/2.png' },
  { id: 2, gradient: 'var(--gradient-gallery-2)', label: 'Our Story', src: '/images/3.png' },
  { id: 3, gradient: 'var(--gradient-gallery-3)', label: 'In Love', src: '/images/4.png' },
  { id: 4, gradient: 'var(--gradient-gallery-4)', label: 'Joy', src: '/images/5.png' },
  { id: 5, gradient: 'var(--gradient-gallery-5)', label: 'Forever', src: '/images/6.png' },
]
