    ...
    >
      <div style={{ maxWidth: 480, margin: '0 auto' }}>
                ...
                {GIFTS.bank.map(({label, value}) => (
                  <div
                    ...
                    style={{
                      ...
                      alignItems: 'baseline',
                      padding: '7px 0',
                      borderBottom: '1px solid rgba(var(--color-gold-rgb),0.1)',
                      gap: 12,
                    }}
                  >
                    <span className="font-body" style={{ fontSize: 10, color: 'var(--color-gold-dark)', opacity: 0.65, flexShrink: 0 }}>
                      {label}
                    </span>
                    <span className="font-body" style={{ fontSize: 11, color: 'var(--color-heading)', fontWeight: 500, textAlign: 'right', wordBreak: 'break-all' }}>
                      {value}
                    </span>
                  </div>
                ))}
        ...
        >
          ...
          <div>
            <p className="font-body uppercase" style={{ fontSize: 9, letterSpacing: '0.26em', color: 'var(--color-gold)', marginBottom: 6 }}>
              Envelope Box
            </p>
