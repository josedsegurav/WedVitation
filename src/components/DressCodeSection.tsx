      ...
      <div style={{ maxWidth: 480, margin: '0 auto', textAlign: 'center' }}>
        ...
        >
          ...
          <p
            ...
            style={{ fontSize: '1.6rem', color: 'var(--color-gold)', marginBottom: 4, lineHeight: 1.2 }}
          >
            {DRESS_CODE.style}
          </p>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 10, flexWrap: 'wrap' }}>
            {DRESS_CODE.reservedColors.map(({ name, hex }) => (
              <div
                key={name}
                style={{
                  display: 'flex',
              ...
              >
                ...
                <span className="font-body" style={{ fontSize: 15, letterSpacing: '0.08em', color: 'var(--color-dark-text-muted)' }}>
                  {name}
                </span>
              </div>
            ))}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 36 }}>
          ...
          <span className="font-body uppercase" style={{ fontSize: 9, letterSpacing: '0.3em', color: 'var(--color-gold)', opacity: 0.5 }}>
            Dress to Impress
          </span>
