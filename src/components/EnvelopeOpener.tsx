...
const Z = {
  bottomFold: 1,
  body:       10,
  card:       2,   // behind seal & flap while closed; boosted to 25 when rising
  seal:       100,  // always above body & card, always above flap when open
  flap:       50,  // above seal while closed; drops to 3 while opening
}
...
export default function EnvelopeOpener({ onOpen }: Props) {
  ...
  return (
    <div
      onClick={handleOpen}
      className="h-screen inset-0 z-50 flex flex-col items-center justify-center cursor-pointer overflow-hidden select-none"
    ...
    >
      ...
      {/* Corner ornaments */}
      <span className="absolute pointer-events-none animate-float" style={{ top: 40,   left: 32,  fontSize: 18, color: 'var(--color-gold)', opacity: 0.25, animationDelay: '0s'   }}>✦</span>
      <span className="absolute pointer-events-none animate-float" style={{ top: 68,   right: 40, fontSize: 13, color: 'var(--color-gold)', opacity: 0.20, animationDelay: '1.5s' }}>✦</span>
      <span className="absolute pointer-events-none animate-float" style={{ bottom: 56, left: 44, fontSize: 15, color: 'var(--color-gold)', opacity: 0.20, animationDelay: '1s'   }}>✦</span>
      <span className="absolute pointer-events-none animate-float" style={{ bottom: 40, right: 30, fontSize: 17, color: 'var(--color-gold)', opacity: 0.25, animationDelay: '2.5s' }}>✦</span>
      ...
      <div className="flex flex-col items-center" style={{ perspective: '900px' }}>
        ...
        >
          <p className="font-body uppercase" style={{ fontSize: 11, letterSpacing: '0.32em', color: 'var(--color-gold)', marginBottom: 4 }}>
            You are invited to
          </p>
          <h1
        ...
        <div style={{ position: 'relative', width: ENV_W, height: ENV_H, flexShrink: 0 }}>
          ...
          <div style={{
            ...
            borderRadius: 4,
            background: 'var(--gradient-envelope-card)',
            boxShadow: '0 -4px 18px rgba(139,105,20,0.12)',
            display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 6,
            zIndex: cardRising ? 25 : Z.card,
            transform: cardRising ? `translateY(-${ENV_H + 24}px)` : 'translateY(0)',
            transition: 'transform 1s cubic-bezier(0.33,1,0.68,1)',
          }}>
            <div style={{ width: 36, height: 1, background: 'var(--gradient-ornament-line-r)' }} />
            <span className="font-script" style={{ fontSize: 21, color: 'var(--color-gold)', lineHeight: 1.2 }}>Sofia &amp; Marco</span>
            <span className="font-body uppercase" style={{ fontSize: 9, letterSpacing: '0.18em', color: 'var(--color-gold-dark)' }}>June 15 · 2026</span>
            <div style={{ width: 36, height: 1, background: 'var(--gradient-ornament-line-r)' }} />
          </div>
          ...
          <div style={{
            ...
            background: 'var(--gradient-wax-seal)',
          ...
          <div style={{
            ...
            zIndex: isOpening ? Z.card : Z.flap,   // drops to 3 when rotating away
          }}>
            <div style={{
              width: '100%', height: '100%',
              clipPath: 'polygon(0 0, 100% 0, 50% 100%)',
              background: 'var(--gradient-wax-highlight)',
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 24, height: 1, background: 'var(--gradient-ornament-line-r)' }} />
            <p className="font-body uppercase" style={{ fontSize: 10, letterSpacing: '0.22em', color: 'var(--color-gold)' }}>
              Tap to open your invitation
            </p>
            <div style={{ width: 24, height: 1, background: 'var(--gradient-ornament-line-l)' }} />
          </div>
          <div className="mt-3 animate-bounce" style={{ color: 'var(--color-gold)', opacity: 0.55 }}>
      ...
      <p
        ...
        style={{ fontSize: 9, letterSpacing: '0.25em', color: 'var(--color-gold-dark)', opacity: 0.28 }}
      >
        Wedding Invitation
      </p>
    </div>
