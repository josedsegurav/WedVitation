  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: 'center', maxWidth: 480, padding: '0 32px', position: 'relative' }}>
        ...
        <p style={{ fontSize: 10, letterSpacing: '0.38em', textTransform: 'uppercase', color: '#C9A96E', marginBottom: 16 }}>
        ...
        <p style={{ fontSize: 11, letterSpacing: '0.1em', color: '#8B6914', opacity: 0.7, marginBottom: 40 }}>
          {guest.passes === 1
        ...
        <button
          ...
          style={{
            ...
            color: '#FAF6F0', fontFamily: 'inherit',
